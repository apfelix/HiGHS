...
HighsStatus Highs::optimizeModel() {
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: Before exactResizeModel()\n");
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: Before model_.lp_.ensureColwise()\n");
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: use_simplex_or_ipm? %b\n", use_simplex_or_ipm);
  if (!use_simplex_or_ipm) {
    // Leaving HiGHS to choose method according to model class
    if (model_.isQp()) {
      highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: if isQp() \n");
      if (model_.isMip()) {
        if (options_.solve_relaxation) {
      ...
      highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: if isMip() and no relaxation \n");
  ...
  if (model_.isMip()) {
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: model_.isMip() and either relaxation or no choice\n");
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: Solve the model as an LP\n");
  ...
  if (options_.icrash) {
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: if icrash\n");
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: define solveLP lambda\n");
  auto solveLp = [&](HighsLp& lp, const std::string& lpSolveDescription,
    ...
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: in lambda before callSolveLp()\n");
    call_status = callSolveLp(lp, lpSolveDescription);
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: in lambda after callSolveLp()\n");
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: Before LP presolve if\n");
  if ((has_basis || options_.presolve == kHighsOffString || unconstrained_lp) &&
      solver_will_use_basis) {
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: Start of LP without presolve\n");
    ...
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 1\n");
    ...
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: before switch presolve status\n");
    switch (model_presolve_status_) {
      case HighsPresolveStatus::kNotPresolved: {
        ekk_instance_.lp_name_ = "Original LP";
        highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 2\n");
      ...
      case HighsPresolveStatus::kNotReduced: {
        ...
        highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 3\n");
      ...
      case HighsPresolveStatus::kReduced: {
        ...
        highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 4\n");
      ...
      case HighsPresolveStatus::kUnboundedOrInfeasible: {
        ...
        highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 5\n");
        solveLp(incumbent_lp,
    ...
    // End of presolve
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: after switch presolve status\n");
    //
    ...
    highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: before postsolve if\n");
    if (have_optimal_reduced_solution || have_unknown_reduced_solution) {
      highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: if running postsolve\n");
      ...
      if (postsolve_status == HighsPostsolveStatus::kSolutionRecovered) {
        ...
        if (!basis_.valid) {
          ...
          highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 6\n");
          solveLp(incumbent_lp,
    ...
    */
    if (consider_pdlp_cleanup) {
      ...
      if (tryPdlpCleanup(pdlp_cleanup_iteration_limit, presolved_lp_info)) {
        ...
        highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: solveLp 7\n");
        solveLp(incumbent_lp,
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: After LP presolve if\n");
  ...
  highsLogUser(my_options.log_options, HighsLogType::kInfo, "FELIX: Highs::optimizeModel: End of Function\n");
  return returnFromOptimizeModel(return_status, undo_mods);
}
